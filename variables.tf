...
variable "ssh_public_key" {
  type        = string
  description = "The contents of the SSH public key file. Used to allow login for workers/bastion/operator."
  default     = null
}
...
variable "cluster_id" {
  type        = string
  default     = null
  description = "Existing cluster OCID."
}
...
variable "deploy_diffdock" {
  type        = bool
  default     = true
  description = "Controls the deployment of the NIM DiffDock helm chart."
}

variable "diffdock_user_values_override" {
  type        = string
  default     = ""
  description = "User provided values to override the NIM DiffDock helm chart defaults and those generated by Terraform using the templates."
}
...
variable "jupyter_admin_password" {
  ...
  validation {
    condition     = length(var.jupyter_admin_password) >= 6 && var.jupyter_admin_password != "<admin-password>"
    error_message = "The password must be at least 6 characters and not equal to '<admin-password>'."
  }
}

variable "jupyter_playbooks_repo" {
  type        = string
  default     = "https://github.com/robo-cap/generative-virtual-screening.git"
...
variable "alphafold2_image_repository" {
  type        = string
  default     = "nvcr.io/nim/deepmind/alphafold2"
  description = "The Alphafold2 NIM container image repository."
}

variable "alphafold2_image_tag" {
  type        = string
  default     = "1.0.0"
  description = "The Alphafold2 NIM container image tag."
}

variable "molmim_image_repository" {
  type        = string
  default     = "nvcr.io/nim/nvidia/molmim"
  description = "The MolMIM NIM container image repository."
}

variable "molmim_image_tag" {
  type        = string
  default     = "1.0.0"
  description = "The MolMIM NIM container image tag."
}

variable "diffdock_image_repository" {
  type        = string
  default     = "nvcr.io/nim/mit/diffdock"
  description = "The DiffDock NIM container image repository."
}

variable "diffdock_image_tag" {
  type        = string
  default     = "2.0.0"
  description = "The DiffDock NIM container image tag."
}
